...
public record MovieDto(UUID uuid, @NotEmpty(message = "Title missing") String title, int releaseYear,
                       @NotEmpty(message = "Director missing") String director, float rating, String genre) {
